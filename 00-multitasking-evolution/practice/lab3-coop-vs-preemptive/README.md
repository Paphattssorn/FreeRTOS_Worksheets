...
เพราะสลับงานให้อัตโนมัติไม่ต้องรอ
2. ข้อดีของ Cooperative Multitasking คืออะไร?
โครงสร้างง่าย ใช้ทรัพยากรน้อย ไม่มีแย่ง CPU
3. ข้อเสียของ Cooperative Multitasking คืออะไร?
ถ้างานค้าง ระบบทั้งหมดยังทำงานต่อไม่ได้
4. ในสถานการณ์ใดที่ Cooperative จะดีกว่า Preemptive?
เหมาะกับ ระบบเล็ก งานไม่เร่งด่วน หรือควบคุมลำดับเอง
5. เหตุใด Preemptive จึงเหมาะสำหรับ Real-time systems?
เหมาะกับ Real-time เพราะตอบสนองเร็วทันเวลา
