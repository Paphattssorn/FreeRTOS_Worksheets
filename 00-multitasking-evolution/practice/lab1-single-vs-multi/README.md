...
Single Task → ปุ่มตอบสนองช้า เพราะต้องรอจบงานอื่นก่อน
Multi Task → ปุ่มตอบสนองไว เพราะมี Task แยกตรวจปุ่มโดยเฉพาะ

2. ใน Single Task System งานไหนที่ทำให้การตอบสนองล่าช้า?
งานหน่วงเวลา (delay) หรือกระพริบ LED ทำให้ไม่อ่านปุ่มทันที
