...
xQueueSend() จะรอจนหมดเวลา (1 วินาที) ถ้ายังไม่มีที่ว่าง → ส่งไม่สำเร็จ ขึ้นข้อความ “queue full?”

2. เมื่อ Queue ว่าง การเรียก `xQueueReceive` จะเกิดอะไรขึ้น?
xQueueReceive() จะรอข้อมูล (5 วินาที) ถ้าไม่มีข้อมูลเข้า → รับไม่สำเร็จ ขึ้นข้อความ “No message received”

3. ทำไม LED จึงกะพริบตามการส่งและรับข้อความ?
เพราะในโค้ดมีคำสั่งให้ LED ติด–ดับทุกครั้งที่มีการ ส่งหรือรับข้อความสำเร็จ 
